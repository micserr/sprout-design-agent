...
description: >
  ...
  user journeys, interactive prototyping, design QA, and handoff. Includes a
  senior product design advisor agent and 11 supporting skills.
agents:
